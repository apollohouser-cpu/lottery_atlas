...
class StateScratchCatalogFeedService {
  ...
  static const List<String> _bootstrapAssets = <String>[
    ...
    'data/kansas_scratch_catalog.initial.json',
    'data/nebraska_scratch_catalog.initial.json',
    ...
    'data/connecticut_scratch_catalog.initial.json',
    'data/maine_scratch_catalog.initial.json',
    'data/vermont_scratch_catalog.initial.json',
    'data/new_hampshire_scratch_catalog.initial.json',
    'data/delaware_scratch_catalog.initial.json',
    'data/idaho_scratch_catalog.initial.json',
    ...
    'data/ohio_scratch_catalog.generated.json',
    'data/colorado_scratch_catalog.generated.json',
    'data/texas_scratch_catalog.generated.json',
  ];
  ...
  static _ScratchCatalogFeed _parse(String raw, {bool downloaded = false}) {
    ...
    for (final item in rawCatalogs) {
      ...
      updatedAtByState[stateName] =
          DateTime.tryParse(
            (catalog['updatedAt'] ?? root['updatedAt'])?.toString() ?? '',
          )?.toUtc() ??
  ...
  static String _encode(_ScratchCatalogFeed feed) => jsonEncode(
    <String, dynamic>{
