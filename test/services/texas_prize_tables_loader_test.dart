...
void main() {
  ...
  final raw = File('data/texas_draw_tiers.generated.json').readAsStringSync();
  ...
  test('offline first launch uses bundle without changing any dates', () async {
    final result = await TexasPrizeTablesLoader(
  ...
  test(
    ...
    () async {
      String? saved;
      final loader = TexasPrizeTablesLoader(
        readCache: () async => null,
